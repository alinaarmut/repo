...
Проект демонстрирует реализацию безопасного кода и автоматизированный анализ уязвимостей через CI/CD (SpotBugs и OWASP Dependency-Check).
...
- OWASP Dependency-Check: Анализ зависимостей на известные уязвимости (SCA).

- GitHub Actions: Автоматический запуск сборки, тестов и анализа при push/pull request в ветки main и info-1
